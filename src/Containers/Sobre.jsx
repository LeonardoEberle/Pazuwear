...
function Sobre() {
  return (
    <main className="sobre-page">
      ...
      <section className="sobre-section who-we-are">
      ...
      {/* Section 3 — Design / Production / Packaging */}
      <section className="sobre-section ethics">
        <div className="sobre-container ethics-layout">
          <p className="ethics-intro">We are also committed to be ethically conscious in our choices besides the fabric:</p>
